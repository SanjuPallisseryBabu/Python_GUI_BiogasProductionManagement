...
def update_step_downward_plot(smoothed=False):
    ...
    ax2_down = ax1_down.twinx()  # Secondary y-axis
...
# Update function for Step Upward Plot (similar changes as Step Downward)
